...
for mod in sys.modules:
    if (mod[0:15] == 'SVN.sublimesvn.' or mod[0:11] == 'sublimesvn.' or mod == 'sublimesvn') and sys.modules[mod] != None:
...
try:
    ...
    from sublimesvn.config import (init_config)
...
settings_dict = {'svn_binary_path': None}
...
try:
    ...
    class SvnInit(svn_threads.HookedThread):
        def run_with_except(self):
            try:
                SVN.init(svn_binary_path=settings_dict['svn_binary_path'])
